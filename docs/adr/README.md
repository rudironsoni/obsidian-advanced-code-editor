...
- `0008-native-api-scroll-performance.md`: improve Live Preview horizontal-scroll responsiveness through native row scroll, Obsidian/CodeMirror lifecycle APIs, and hard performance regression gates.
