...
export class ShikiSettingsTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(this.containerEl)
			...
			.addText(text => {
				text
					.setValue(String(this.plugin.settings.ecEditorFontSize))
		...
		new Setting(this.containerEl)
			...
			.addText(text => {
				text
					.setValue(this.plugin.settings.ecEditorFontFamily)
					.onChange(async value => {
		...
		new Setting(this.containerEl)
			...
			.addText(text => {
				text
					.setValue(String(this.plugin.settings.ecEditorLineHeight))
					.onChange(async value => {
						const num = Number.parseInt(value, 10);
