...
description: Desktop and mobile emulation testing orchestrator for Obsidian plugins. Use this subagent to run comprehensive tests on both desktop and mobile environments using MCP tools (obsidian-cli, electron-devtools). Covers plugin load verification, UI rendering, mobile emulation, screenshot comparison, and performance regression detection.
---
